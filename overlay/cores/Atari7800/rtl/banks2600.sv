			...
			case (state)
				...
				AR_LOAD_HEADER: begin
					...
					if (header_a < 7) begin
						...
						header_a <= 0;
						header_array[4] <= 8'h55 - (header_array[0] + header_array[1] + header_array[2] + header_array[3] + header_array[4] + header_array[5] + header_array[6] + header_array[7]);   // .sum() spelled out: Vivado has no array reduction methods
