// N64 core PLL "pll_0002", UltraScale+ variant -- MMCME4_ADV.
//
...
//
//   refclk 50 MHz / DIVCLK_DIVIDE 1 -> PFD 50.000 MHz
//   CLKFBOUT_MULT_F 22.5 -> VCO 1125.0000 MHz  (MMCME4 -2: 800-1600)
//   outclk_0 = VCO/18     =    62.5000 MHz  (target 62.500000, +0.000 %)
//   outclk_1 = VCO/12     =    93.7500 MHz  (target 93.750000, +0.000 %)
//   outclk_2 = VCO/9      =   125.0000 MHz  (target 125.000000, +0.000 %)
//   outclk_3 = VCO/18     =    62.5000 MHz  (target 62.500000, +0.000 %)
// Largest frequency error against the Altera targets: 0.000 %.
...
module pll_0002 (
	...
	BUFG bufg3 (.I(clkout3), .O(outclk_3));
endmodule
