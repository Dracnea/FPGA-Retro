// Patched copy for Vivado: the port list uses DecInst_t from SCUDSP_PKG, which upstream
// imports only inside the module body (Quartus tolerates that, Vivado does not).
import SCUDSP_PKG::*;
