...
// made reg; no functional change. Upstream: upstream/rtl/hps2pad.sv
module HPS2PAD (
	input              CLK,
	input              RST_N,
	input              SMPC_CE,
	
	output     reg [ 6: 0] PDR1I,
	input      [ 6: 0] PDR1O,
	input      [ 6: 0] DDR1,
	output     reg [ 6: 0] PDR2I,
	input      [ 6: 0] PDR2O,
	input      [ 6: 0] DDR2,
		...
		if (!RST_N) begin
			...
			case (JOY1_TYPE)
				...
				PAD_MOUSE: begin
					...
					endcase
					if (PDR1O[6] == 1'b1) begin OUT1 <= 4'h0; TL1 <= 1; STATE1 <= 5'd0; end
				end
			...
			case (JOY2_TYPE)
				...
				PAD_MOUSE: begin
					...
					endcase
					if (PDR2O[6] == 1'b1) begin OUT2 <= 4'h0; TL2 <= 1; STATE2 <= 5'd0; end
				end
