// Patched copy of upstream pll.v for the UltraScale+ shim: reconfig ports accepted and ignored.
...
module pll (
		...
		// the top drives the Altera reconfig interface (pll_cfg); no such thing on an MMCM shim
